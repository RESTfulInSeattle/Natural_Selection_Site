...
export default async function About() {
  ...
  return (
    <div className="min-h-screen gradient-section-light">
      <ContentHero 
        title={aboutContent.frontmatter.title || "About Natural Selection"}
        subtitle="Creating exceptional musical experiences since 2003"
        date={aboutContent.frontmatter.date}
        image={aboutContent.images?.[0]?.path}
      />
      ...
      <ContentSection background="white">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="bg-white/90 backdrop-blur-sm rounded-lg p-8 border border-white/30 shadow-xl">
              <h3 className="text-2xl font-bold text-gray-900 mb-6">28 Years Experience</h3>
              <div className="grid grid-cols-2 gap-4 text-center">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600">Musical Passion</div>
                </div>
                <div>
      ...
      <ContentSection>
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600">Comprehensive audio solutions for every need</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Venue & Event DJ</h3>
            <p className="text-sm text-gray-600">Professional DJing for all events</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Sound System & Lighting</h3>
            <p className="text-sm text-gray-600">Professional audio and visual equipment</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Audio Mastering</h3>
            <p className="text-sm text-gray-600">Professional mastering and engineering</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Acoustical Consultation</h3>
            <p className="text-sm text-gray-600">Studio design and acoustic treatment</p>
          </div>
        </div>
      </ContentSection>
